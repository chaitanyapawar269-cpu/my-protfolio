...
function createSlottable(ownerName) {
  const Slottable2 = __name6((props) => "child" in props ? props.children(props.child) : props.children, "Slottable");
...
var getSlottableElementFromSlottable = __name6((slottable, child) => {
...
var createSlotError = __name6((ownerName) => {
  return `${ownerName} failed to slot onto its children. Expected a single React element child or \`Slottable\`.`;
}, "createSlotError");
var createSlottableError = __name6((ownerName) => {
...
//# sourceMappingURL=chunk-DHVAPT4A.js.map
