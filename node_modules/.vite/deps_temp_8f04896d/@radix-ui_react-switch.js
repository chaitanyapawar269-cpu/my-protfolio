...
function SwitchProvider(props) {
  ...
  const [userInteractionCount, onUserInteraction] = React2.useReducer(
    (count) => count + 1,
    0
  );
...
var SwitchTrigger = React2.forwardRef(
  __name2(function SwitchTrigger2({ __scopeSwitch, onClick, ...switchProps }, forwardedRef) {
    const {
      control,
      form,
      value,
    ...
    React2.useEffect(() => {
      ...
      if (associatedForm instanceof HTMLFormElement) {
        const reset = __name2(() => setChecked(initialCheckedStateRef.current), "reset");
...
var Switch = React2.forwardRef(
  ...
  __name2(function Switch2(props, forwardedRef) {
    const {
      __scopeSwitch,
      name,
      checked,
...
var SwitchThumb = React2.forwardRef(
  __name2(function SwitchThumb2(props, forwardedRef) {
...
var SwitchBubbleInput = React2.forwardRef(
  // blank line to reduce diff noise
  __name2(function SwitchBubbleInput2({ __scopeSwitch, onClick, ...props }, forwardedRef) {
    const {
      control,
      hasConsumerStoppedPropagationRef,
      userInteractionCount,
    ...
    const shouldStopClickPropagationRef = React2.useRef(false);
    const prevCheckedRef = React2.useRef(checked);
    const prevUserInteractionCountRef = React2.useRef(userInteractionCount);
    React2.useEffect(() => {
    ...
    const defaultCheckedRef = React2.useRef(checked);
    return (0, import_jsx_runtime.jsx)(
      Primitive.input,
      {
        type: "checkbox",
