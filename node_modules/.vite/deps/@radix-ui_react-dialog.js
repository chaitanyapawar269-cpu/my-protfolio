...
var DismissableLayer = React3.forwardRef(
  ...
  __name3(function DismissableLayer2(props, forwardedRef) {
    const {
    ...
    React3.useEffect(() => {
      const handleUpdate = __name3(() => force({}), "handleUpdate");
...
var DismissableLayerBranch = React3.forwardRef(__name3(function DismissableLayerBranch2(props, forwardedRef) {
  const context = React3.useContext(DismissableLayerContext);
...
__name3(useDismissableLayerSurface, "useDismissableLayerSurface");
var IS_TRUE = __name3(() => true, "IS_TRUE");
function usePointerDownOutside(onPointerDownOutside, args) {
  ...
  React3.useEffect(() => {
    ...
    __name3(resetOutsideInteraction, "resetOutsideInteraction");
    function isOutsideInteractionIntercepted() {
      return Array.from(interceptedOutsideInteractionEventsRef.current.values()).some(Boolean);
    }
    __name3(isOutsideInteractionIntercepted, "isOutsideInteractionIntercepted");
    ...
    __name3(handleInteractionCapture, "handleInteractionCapture");
    function handleInteractionBubble(event) {
      if (isPointerDownOutsideRef.current) {
        interceptedOutsideInteractionEventsRef.current.set(event.type, false);
      }
    }
    __name3(handleInteractionBubble, "handleInteractionBubble");
    const handlePointerDown = __name3((event) => {
      if (event.target && !isPointerInsideReactTreeRef.current) {
        ...
        __name3(handleAndDispatchPointerDownOutsideEvent2, "handleAndDispatchPointerDownOutsideEvent");
  ...
  return {
    ...
    onPointerDownCapture: __name3(() => isPointerInsideReactTreeRef.current = true, "onPointerDownCapture")
  };
}
__name3(usePointerDownOutside, "usePointerDownOutside");
function useFocusOutside(onFocusOutside, ownerDocument = globalThis == null ? void 0 : globalThis.document) {
  const handleFocusOutside = useCallbackRef(onFocusOutside);
  const isFocusInsideReactTreeRef = React3.useRef(false);
  React3.useEffect(() => {
    const handleFocus = __name3((event) => {
  ...
  return {
    onFocusCapture: __name3(() => isFocusInsideReactTreeRef.current = true, "onFocusCapture"),
    onBlurCapture: __name3(() => isFocusInsideReactTreeRef.current = false, "onBlurCapture")
  };
}
__name3(useFocusOutside, "useFocusOutside");
function dispatchUpdate() {
  const event = new CustomEvent(CONTEXT_UPDATE);
  document.dispatchEvent(event);
}
__name3(dispatchUpdate, "dispatchUpdate");
...
__name3(handleAndDispatchCustomEvent, "handleAndDispatchCustomEvent");
...
var FocusScope = React4.forwardRef(
...
var Portal = React5.forwardRef(
  __name5(function Portal2(props, forwardedRef) {
    var _a;
...
__name7(FocusGuards, "FocusGuards");
...
__name7(useFocusGuards, "useFocusGuards");
...
__name7(createFocusGuard, "createFocusGuard");
...
var Dialog = __name8((props) => {
  ...
  const [titleCount, setTitleCount] = React17.useState(0);
  const [descriptionCount, setDescriptionCount] = React17.useState(0);
...
var DialogTrigger = React17.forwardRef(
  __name8(function DialogTrigger2(props, forwardedRef) {
...
var DialogPortal = __name8((props) => {
...
var DialogOverlay = React17.forwardRef(
  __name8(function DialogOverlay2(props, forwardedRef) {
...
var DialogOverlayImpl = React17.forwardRef(
  // blank line to reduce diff noise
  __name8(function DialogOverlayImpl2(props, forwardedRef) {
...
var DialogContent = React17.forwardRef(
  __name8(function DialogContent2(props, forwardedRef) {
...
var DialogContentModal = React17.forwardRef(
  // blank line to reduce diff noise
  __name8(function DialogContentModal2(props, forwardedRef) {
    const context = useDialogContext(CONTENT_NAME, props.__scopeDialog);
    const contentRef = React17.useRef(null);
...
var DialogContentNonModal = React17.forwardRef(
  // blank line to reduce diff noise
  __name8(function DialogContentNonModal2(props, forwardedRef) {
    const context = useDialogContext(CONTENT_NAME, props.__scopeDialog);
...
var DialogContentImpl = React17.forwardRef(
  // blank line to reduce diff noise
  __name8(function DialogContentImpl2(props, forwardedRef) {
...
var DialogTitle = React17.forwardRef(
  __name8(function DialogTitle2(props, forwardedRef) {
...
var DialogDescription = React17.forwardRef(
  // blank line to reduce diff noise
  __name8(function DialogDescription2(props, forwardedRef) {
...
var DialogClose = React17.forwardRef(
  __name8(function DialogClose2(props, forwardedRef) {
...
var WarningProvider = __name8((props) => {
  return props.children;
}, "WarningProvider");
